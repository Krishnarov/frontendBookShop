  ...
  return (
    <div>
      ...
      <div className="w-full flex items-center justify-center my-10">
        <div className="flex w-2/4 items-center rounded-lg bordered shadow-md py-8 px-8 mt-20 relative">
          <div className="w-2/4 ">
          ...
          <div className="w-2/4 px-4 ">
            ...
            <div className=" absolute right-10 top-10 px-2 border text-white bg-pink-500 rounded-2xl">{items.type}₹</div>
